			...
			btnFormAdd.setOnAction(e4 -> {
				try {
					if (editTotal.getText().equals("") || editAvg.getText().equals("")) {
						...
						Student student = new Student(editName.getText(), editYear.getText(), editBan.getText(),
								editGender.getText(), editKorean.getText(), editEnglish.getText(), editMath.getText(),
